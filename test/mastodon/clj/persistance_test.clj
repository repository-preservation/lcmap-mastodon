...
(deftest resource-path-test-ard
  (with-redefs [config/config {:data_type "ard" :data_host "http://datahost.gov" :data_dir "tiles"}]
    (is (= (persist/resource-path "LE07_CU_005015_20021221_20170919_C01_V01_BTB6.tif")
           "http://datahost.gov/tiles/etm/ARD_Tile/2002/CU/005/015/LE07_CU_005015_20021221_20170919_C01_V01_BT.tar/LE07_CU_005015_20021221_20170919_C01_V01_BTB6.tif"))))

(deftest resource-path-test-aux
  (with-redefs [config/config {:data_type "aux" :data_host "http://auxhost.gov"}]
...
(deftest ingest-test
  (with-fake-http [{:url "http://www.iwdshost.gov/inventory" :method :post} {:status 200 :body "ok"}]
    (with-redefs [config/config {:data_type "ard" :data_host "foohost.gov"}]
